...
final class Version20260119182359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO user (id, email, first_name, last_name, password,is_active) VALUES (1, \'system@internal\', \'system\', \'system\', \'$2y$13$zKLYF85ToqWY1kM3wetJouvEU0zaPsYRbybQQzdJTzt\',0)');
    }
