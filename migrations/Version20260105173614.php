 ...
 */
final class Version20260105173614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE workspace_user (id INT AUTO_INCREMENT NOT NULL, workspace_id INT DEFAULT NULL, user_id INT DEFAULT NULL, role VARCHAR(50) NOT NULL, INDEX IDX_C971A58B82D40A1F (workspace_id), INDEX IDX_C971A58BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
